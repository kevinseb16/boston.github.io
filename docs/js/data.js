...
const DATA = {
  ...
  days:[
    ...
    /* ===================== SUN 7/5 — BEACH DAY ===================== */
    {
      ...
      blocks:[
        ...
        {slot:"Evening", icon:"🌙", activities:[
          ...
          {name:"Supergirl — movie night (flexible!)", cat:"Local experience", ticket:{go:"TBD — pick a showtime", hard:false, note:"Costco discounted tickets already bought — PLUS 3× $20 ($60 total) AMC gift cards still to be assigned to a showtime. Amanda has the gift card."},
    ...
    /* ===================== MON 7/6 — LIL' ITALY ===================== */
    {
      ...
      blocks:[
        {slot:"Morning", icon:"🔬", activities:[
          {name:"Museum of Science (+ Planetarium / IMAX)", cat:"Boston (read with accent)", ticket:{go:"Anytime 9 AM–5 PM", len:"2 hours", hard:false, note:"General admission — enter whenever you like."},
          ...
          {name:"IMAX: Deep Sky", cat:"Boston (read with accent)", leg:"🚶 inside the Museum of Science",
           ticket:{go:"11:00 AM", len:"40 min", hard:true, note:"Mugar Omni Theatre, Red Wing, Level 1.\nBring or buy some snacks! Keep in mind Lil' Italy is just around the corner, so you want to keep an open stomach. 🍝"},
           notes:"A breathtaking giant-dome IMAX documentary at the Museum's Mugar Omni Theatre, taking you deep into the cosmos via the James Webb telescope's images. Fixed showtime — don't be late!",
           address:"Museum of Science (Mugar Omni Theatre), 1 Museum of Science Driveway, Boston, MA 02114",
           transit:T('<span class="line-tag L-green">Green Line</span> — Science Park/West End.')},
          {name:"Charles River Boat Tour", cat:"Boston (read with accent)", pl:"charlesriverboattour", ticket:{go:"1:30–2:40 PM", len:"70 min", hard:true, note:"Arrive 15 minutes early and bring your confirmation email to the ticket booth to check in. $4 discounted 8-hour parking is available!"},
    ...
    /* ===================== TUE 7/7 — NEWPORT ===================== */
    {
      ...
      blocks:[
        {slot:"Morning", icon:"🏰", activities:[
          {name:"The Breakers", cat:"A nice trip", pl:"newportmansionsthebreakers", ticket:{go:"12:00 PM (noon)", len:"2 hours", hard:true, note:"Open 9 AM–5 PM; last admission 4 PM."},
          ...
          {name:"Marble House", cat:"A nice trip", pl:"newportmansionsmarblehouse", ticket:{go:"2:00 PM", len:"2 hours", hard:false, note:"Flexible — head over after The Breakers. Open 9 AM–5 PM; last admission 4 PM."},
    ...
    /* ===================== WED 7/8 — BACK BAY ===================== */
    {
      ...
      blocks:[
        {slot:"Morning", icon:"🎨", activities:[
          {name:"Isabella Stewart Gardner Museum", cat:"Boston (read with accent)", ticket:{go:"11:00 AM", len:"2 hours", hard:true, note:"Please arrive no more than five minutes earlier than your designated time slot. They may not be able to accommodate visitors more than five minutes before the time on their ticket."},
        ...
        {slot:"Afternoon", icon:"⛪", activities:[
          ...
          {name:"Mary Baker Eddy Library & the Mapparium", cat:"Boston (read with accent)", ticket:{go:"4:00 PM", len:"~20 min", hard:true, note:"Arrive 10 minutes early. Mapparium open 10 AM–5 PM. Tickets are required to view the Mapparium globe. The last tour starts at 4:40 PM. All other exhibits in the 'How Do You See the World?' experience are free to the public. Food is not allowed inside the exhibit space — you may bring a clear, plastic water bottle filled with water; no other drink is allowed. They will exchange your ticket for a different day or time if you need to reschedule for any reason, subject to availability."},
